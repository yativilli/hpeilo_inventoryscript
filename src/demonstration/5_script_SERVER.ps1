...
Get-HWInfoFromILO -Server @("rmgfa-sioc-cs-de3", "rmdl20test") -Username "Yannik" -Password (ConvertTo-SecureString -String "test!1234" -AsPlainText) -LogLevel 5 -LoggingActivated -DeactivateCertificateValidationILO -ReportPath "U:\IPA\IPA\IPA_Sourcecode_hpeilo_inventoryscript\src\demonstration\dump\" -LogPath "U:\IPA\IPA\IPA_Sourcecode_hpeilo_inventoryscript\src\demonstration\dump\";